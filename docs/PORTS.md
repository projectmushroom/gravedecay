...
| 4714 | 127.0.0.1 | gravedecay-net (gravenet — realtime network flow monitor) | `tailscale serve` → https `/net` (widen bind via `GRAVENET_BIND` drop-in only if LAN clients should load it directly) |
