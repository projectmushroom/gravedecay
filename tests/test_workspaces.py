...
class WorkspaceTests(unittest.TestCase):
    ...
    def test_lifecycle_is_idempotent_and_isolated(self):
        ...
        self.assertIn("grave-agent-notify", (self.root/"workspaces/alice/.claude/settings.json").read_text())
        self.assertIn('notify = ["', (self.root/"workspaces/alice/.codex/config.toml").read_text())
        self.assertIn("grave-agent-notify", (self.root/"workspaces/alice/.codex/config.toml").read_text())
